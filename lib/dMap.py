...
##########################################################
#
# Dungeon map creator library.
# Source: http://roguebasin.roguelikedevelopment.org/index.php/Dungeon_builder_written_in_Python
#
##########################################################
'''
...
class dMap:
    ...
    def makeMap(self,xsize,ysize,fail,b1,mrooms):
        ...
        # b1=0 for all rooms, b1=100 for all corridors.
...
def main():            
    ...
    for y in range(starty):
        ...
        for x in range(startx):
            if myMap.mapArr[y][x]==0:
                line += "."
            if myMap.mapArr[y][x]==1:
                line += " "
            if myMap.mapArr[y][x]==2:
                line += "#"
            if myMap.mapArr[y][x]==3 or myMap.mapArr[y][x]==4 or myMap.mapArr[y][x]==5:
                line += "="
        print line
