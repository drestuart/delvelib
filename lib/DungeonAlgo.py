'''
http://roguebasin.roguelikedevelopment.org/index.php?title=Python_Curses_Example_of_Dungeon-Building_Algorithm

By Zack Hovatter (http://roguebasin.roguelikedevelopment.org/index.php?title=User:Zackhovatter)
